            ...
            <form action="/contractServlet" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="endDate" class="form-control" required></input>
                    </div>

                    <div class="form-group">
                        <label>Deposit</label>
                        <input name="deposit" class="form-control" required></input>
                    </div>

                    <div class="form-group">
                        <label>Total Money</label>
                        <input name="totalMoney" class="form-control" required></input>
                    </div>
                    <div class="form-group">
